...
TEST(GetFileTable, testGoodDecodeRequest)
{
...
TEST(GetFileTable, testBadDecodeRequest)
{
...
TEST(GetFileTable, testGoodEncodeResponse)
{
...
TEST(GetFileTable, testBadEncodeResponse)
{
    uint8_t completionCode = 0;
